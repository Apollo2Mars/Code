...
datasetName = 'zh_pos'
dataColumns = {0:'tokens', 1:'POS'} #Tab separated columns, column 1 contains the token, 3 the universal POS tag
labelKey = 'POS'
...
embeddingsPath = 'emptyEmb.txt'

# Parameters of the network
params = {'dropout': [0.5, 0.5], 'classifier': 'CRF', 'LSTM-Size': [1024], 'optimizer': 'nadam', 'charEmbeddings': None, 'miniBatchSize': 32}


frequencyThresholdUnknownTokens = 10  # If a token that is not in the pre-trained embeddings file appears at least 50 times in the train.txt, then a new embedding is generated for this word
